...
public interface ProjectInputService {
    ...
    Project createProject(ProjectDto projectDto) throws
    ...
    void deleteProject(String projectID) throws
            ProjectNotFoundException,
            ProjectIsAssignedToCompanyException,
            ProjectIsAssignedToEmployeeException;
    Project updateProject(String projectID, ProjectDto projectDto) throws
            ProjectNotFoundException,
            RemoteEmployeeApiUnavailableException,
            RemoteCompanyApiUnavailableException,
            ProjectFieldsEmptyException,
