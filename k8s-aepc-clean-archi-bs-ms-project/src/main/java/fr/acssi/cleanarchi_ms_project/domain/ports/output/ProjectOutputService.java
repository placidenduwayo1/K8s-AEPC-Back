...
import fr.acssi.cleanarchi_ms_project.domain.exceptions.RemoteCompanyApiUnavailableException;
import fr.acssi.cleanarchi_ms_project.domain.exceptions.RemoteEmployeeApiUnavailableException;
...
public interface ProjectOutputService {
    ...
    Optional<Project> getProjectByID(String projectID) throws
