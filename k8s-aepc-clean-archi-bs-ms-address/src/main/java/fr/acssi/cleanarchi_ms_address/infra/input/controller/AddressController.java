...
AddressController {
    ...
    public void deleteAddress(@PathVariable(name = "addressID") String addressID) throws AddressNotFoundException, AddressAssignedEmployeesException {
    ...
    public Optional<Address> getAddress(@PathVariable(name = "addressID") String addressID) throws AddressNotFoundException {
    ...
    public   List<EmployeeModel> employeesAtAddressThis(@PathVariable(name = "addressID") String addressID) throws AddressNotFoundException {
