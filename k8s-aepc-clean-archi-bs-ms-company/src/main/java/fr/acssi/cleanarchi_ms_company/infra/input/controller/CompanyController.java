...
public class CompanyController {
    ...
    public Company updateCompany(
            ...
            @RequestBody CompanyDto companyDto) throws
            ...
            CompanyConnectStateUnrecognizedException{
        return companyInputService
                .updateCompany(companyID, companyDto);
    }
    ...
    public void deleteCompany(
            @PathVariable(name = "companyID") String companyID) throws
            CompanyNotFoundException,
    ...
    public List<ProjectModel> getProjectsAssignedToCompany(
            @PathVariable(name = "companyID") String companyID) throws
            CompanyNotFoundException {
        return companyInputService
