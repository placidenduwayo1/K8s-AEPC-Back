...
public class EmployeeOutputServiceImpl implements EmployeeOutputService {
    ...
    public EmployeeOutputServiceImpl(
    ...
    private List<Employee> innerUtilityMethod(List<EmployeeModel> employees) {
    ...
    public List<Employee> getAllEmployees() {
        ...
        return innerUtilityMethod(employeesModel);
    }
    ...
    public List<Employee> getEmployeeByInfo(EmployeeDto employeeDto) {
        List<EmployeeModel> employeeModels = employeeRepository
                .findByFirstnameAndLastnameAndEmployeeStateAndEmployeeTypeAndAddressID(
        ...
        return innerUtilityMethod(employeeModels);
    }
    ...
    public Optional<Employee> getEmployeeByID(String employeeID) throws
        ...
        return Optional.of(
                EmployeeMapper
                        .mapEmployeeModelToClass(employeeModel));
    }

    @Override
    public Employee updateEmployee(Employee employee) {
        EmployeeModel employeeModel = EmployeeMapper
                .mapClassToModel(employee);
        EmployeeModel persistedEmployee = employeeRepository
                .save(employeeModel);
        return EmployeeMapper
                .mapEmployeeModelToClass(persistedEmployee);
    }

    @Override
    public void deleteEmployee(Employee employee) {
        employeeRepository
                .delete(EmployeeMapper.mapClassToModel(employee));
    }
